...
test_l26f_multilayer: test_l26f_multilayer.o l26f.o l26f_gguf.o l26f_metal.o l26f_mla_gpu.o l26f_mla_cpu.o l26f_tokenizer.o
	$(CC) $(CFLAGS) -o $@ test_l26f_multilayer.o l26f.o l26f_gguf.o l26f_metal.o l26f_mla_gpu.o l26f_mla_cpu.o l26f_tokenizer.o $(LDLIBS)
...
l26f_mla_gpu.o: l26f_mla_gpu.c l26f.h l26f_metal.h ds4_metal.h
