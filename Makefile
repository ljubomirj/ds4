...
test_l26f_multilayer: test_l26f_multilayer.o l26f.o l26f_gguf.o l26f_metal.o l26f_mla_gpu.o l26f_tokenizer.o
	$(CC) $(CFLAGS) -o $@ test_l26f_multilayer.o l26f.o l26f_gguf.o l26f_metal.o l26f_mla_gpu.o l26f_tokenizer.o $(LDLIBS)
